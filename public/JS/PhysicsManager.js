...
let count_v_time = new BlankVsTime(
    species,
    "count",
    t_step,
    steps,
...
let percent_v_time = new BlankVsTime(
    species,
    "percent",
    t_step,
    steps,
...
function print_info_block() {
    ...
    textnode = document.createTextNode(
        "The time step is: " + t_step + " seconds"
    );
    ...
    textnode = document.createTextNode(
        "There were initially " + reactant_initial + " Reactant Molecules."
    );
    node = document.createElement("p");
    node.appendChild(textnode);
    block.appendChild(node);
    ...
    textnode = document.createTextNode(
        "There were initially " + product_initial + " Product Molecules."
    );
    node = document.createElement("p");
    node.appendChild(textnode);
    block.appendChild(node);
    ...
    textnode = document.createTextNode(
        "The volume of the reactor is " + chamber_volume + " nm^3."
    );
    node = document.createElement("p");
    node.appendChild(textnode);
    block.appendChild(node);
    ...
    textnode = document.createTextNode(
        ...
        reactant_initial / chamber_volume +
        " molecules/nm^3."
    );
    node = document.createElement("p");
    node.appendChild(textnode);
    ...
    textnode = document.createTextNode(
        "This reaction favors the " + favor + " side."
    );
    node = document.createElement("p");
    node.appendChild(textnode);
    block.appendChild(node);
...
document.addEventListener(
    "mousemove",
    () => {
        return visualizer.onDocumentMouseMove();
    },
    false
);
