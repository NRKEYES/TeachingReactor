...
class Visualization {
    ...
    init(incoming_data, chamber_edge_length) {
        ...
        this.controls.autoRotateSpeed = 2; // default is 2
    ...
    configure_outline_passes() {
        ...
        this.impactPass.hiddenEdgeColor.set(new THREE.Color("#FFFFFF"));
        ...
        this.selectedPass.hiddenEdgeColor.set(new THREE.Color("#FFFFFF"));
        ...
        this.newbornPass.hiddenEdgeColor.set(new THREE.Color("#FFFFFF"));
    }
    ...
    pause_animate() {
        ...
        document.title = "PAUSED - NRKinetic Reactor";
        document.getElementById("toggle_animate").innerHTML = "Resume";
    }
    resume_animate() {
        this.should_animate = true;
        document.title = "NRKinetic Reactor";
        document.getElementById("toggle_animate").innerHTML = "Pause";
    }
